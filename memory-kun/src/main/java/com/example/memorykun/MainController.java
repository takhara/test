...
public class MainController {
    ...
    public String updateSubject(UpdateSubjectForm form, RedirectAttributes attr, Integer editSubject) {
    ...
    public String toSphere(ToSphereForm form, RedirectAttributes attr, Integer editSubject) {
        ...
        attr.addFlashAttribute("editSubject", editSubject);
